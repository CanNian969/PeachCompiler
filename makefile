OBJECTS= ./build/compiler.o ./build/cprocess.o ./build/lex_process.o ./build/lexer.o ./build/token.o \
 ./build/parser.o ./build/node.o ./build/helpers/vector.o ./build/helpers/buffer.o
INCLUDES= -I ./
...
clean:
	del .\build\*.o .\build\helpers\*.o main.exe